			...
			<div class="row">
				<div class="col-md-12">
					<div class="top-menu-left">
						...
						<b><i class="fa fa-envelope"></i><a style="color:#fff;" href="mailto:info@havilahshares.com">info@havilahshares.com</a></b>
						<b><i class="fa fa-envelope"></i><a style="color:#fff;" href="mailto:info@havilahshares.com">info@havilahshares.com</a></b>
					</div>				
				</div>				
				<!--<div class="col-md-6">
				...
				<div class="col-md-12">		
					<div class="business-main-menu">		
						...
						<a class="navbar-brand" href="index.php">
							<img style="max-width:180px;" src="logo.svg" class="d-inline-block align-top" alt="">		
								...
								<div class="item">	
									<div class="innerBannerContent row">
										<div class="col-sm-7">
											...
											<p>We are making it easier for first time buyers to get on the property ladder. Available on property purHavilah Shares.</p>
			...
			<div class="row">
				...
				<div class="col-md-3 no-padding">				
					<div class="single-colorful-feature feature-color-1">
						...
						<p>Discover the benefits of a bank account from Havilah Shares.</p>	
					</div>									
				</div>					
				<div class="col-md-3 no-padding">				
							...
							<div class="single-app-present">
								<div class="media">
								  <div class="media-body">
									...
									<p>I’m just a few taps away — open your Havilah Shares® mobile app and say hello.</p>
	    ...
	    <div class="bussiness-footer-content ">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3">
						<h5> Find a branch </h5>
						<a href="branch-locator.html">Find your nearest Havilah Shares Banking location</a>
					</div>							
					<div class="col-md-3">	
                                ...
                                <div class="row">	
                                    <div class="col-md-6">	
                                        <div class="footer-info-left">	
                                            <!--<p><a href="#">Havilah Shares Banking Group</a></p>-->
